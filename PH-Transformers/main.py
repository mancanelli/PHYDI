...
from utils.dataloaders import DatasetHandler1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_tokens', type=int, default=28781)
    parser.add_argument('--rezero', type=bool, default=True)
    parser.add_argument('--ln_vers', type=str, default="None", help="layernorm version")
    ...
    parser.add_argument('--TextArgs', type=str, default='./PH-Transformers/configs/TrainingArguments.txt', help='Path to text with training settings')
    ...
    trainer = Trainer(net, optimizer, scheduler, criterion, epochs=opt.epochs, threshold=opt.threshold,
                      device=device, checkpoint_folder=checkpoint_folder, lr=opt.lr, momentum=opt.momentum, 
