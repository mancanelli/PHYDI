...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10', help='SVHN, CIFAR10')
    parser.add_argument('--img_size', type=int, default=32)
    parser.add_argument('--model', type=str, default='resnet20', help='Models: ...')
    parser.add_argument('--quat_data', type=bool, default=True)
    ...
    parser.add_argument('--train_dir', type=str, default='./PH-CNN/datasets/CIFAR10', help="Folder containg training data. It must point to a folder with images in it.")
    ...
    parser.add_argument('--TextArgs', type=str, default='./PH-CNN/configs/TrainingArguments.txt', help='Path to text with training settings')
    ...
    trainer = Trainer(net, optimizer, scheduler, epochs=opt.epochs, threshold=opt.threshold, use_cuda=opt.cuda, 
                      gpu_num=opt.gpu_num, checkpoint_folder=checkpoint_folder, get_iter_time=opt.get_iter_time, 
                      get_inf_time=opt.get_inf_time, optim_name=optim_name, lr=opt.lr, momentum=opt.momentum, 
                      weight_decay=opt.weight_decay, l1_reg=opt.l1_reg)
