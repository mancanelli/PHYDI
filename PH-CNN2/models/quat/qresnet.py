...
def QResNet18(channels=4, num_classes=10):
    return QResNet(BasicBlock, [2, 2, 2, 2], channels=channels, num_classes=num_classes)
...
def QResNet34(channels=4, num_classes=10):
    return QResNet(BasicBlock, [3, 4, 6, 3], channels=channels, num_classes=num_classes)


def QResNet50(channels=4, num_classes=10):
    return QResNet(Bottleneck, [3, 4, 6, 3], channels=channels, num_classes=num_classes)
...
def QResNet101(channels=4, num_classes=10):
    return QResNet(Bottleneck, [3, 4, 23, 3], channels=channels, num_classes=num_classes)


def QResNet152(channels=4, num_classes=10):
    return QResNet(Bottleneck, [3, 8, 36, 3], channels=channels, num_classes=num_classes)
